...
include_once 'vendor/jipipayo/sphinx-config-builder/SphinxConfigBuilder.php';
...
$src_vulns_arr = Array(
        ...
        'sql_query'             => 'SELECT `id`,`ext-id`, UNIX_TIMESTAMP(`published-datetime`) `published-datetime` ,`score`,`summary` FROM vulns;',
        'sql_attr_uint'         => 'score',
        'sql_attr_timestamp'    => 'published-datetime',
    );
$builder->addEntry('source', 'vulns', $src_vulns_arr);


$idx_vulns_arr = Array(
        'source'                => 'vulns',
        'path'                  => '/var/lib/sphinxsearch/data/vulny',
        'morphology'            => 'none',
        'min_word_len'          => 2,
        'min_prefix_len'        => 0,
        'min_infix_len'         => 0,
...
$builder->addEntry('index', 'vulns', $idx_vulns_arr);
